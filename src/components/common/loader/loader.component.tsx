...
import { ProgressbarComponent } from '@/src/components/common/progressbar/progressbar.component.tsx';
import type { Loader } from '@/src/components/common/loader/loader.type.ts';
