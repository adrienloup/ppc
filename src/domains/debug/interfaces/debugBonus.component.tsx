...
//
//   const updateWire = (quantity: number) => dispatch({ type: 'WIRE_QUANTITY', quantity });
...
//   const updateUnsoldInventoryBonus = (bonus: number) => dispatch({ type: 'UPDATE_UNSOLD_INVENTORY_BONUS', bonus });
//
//   return (
//     <>
//       <form>
