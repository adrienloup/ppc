...
import { wireReducer } from '@/src/domains/wire/application/wire.reducer.ts';
import { ResourcesContext, ResourcesDisContext } from '@/src/domains/wire/infrastructure/resources.context.tsx';
import { RESOURCES_KEY } from '@/src/domains/wire/infrastructure/resources.key.ts';
import { RESOURCES_STATE } from '@/src/domains/wire/infrastructure/resources.state.ts';
...
export const ResourcesProvider: FC<{ children: Children }> = ({ children }) => {
  ...
  const [state, dispatch] = useReducer(wireReducer, resourceStorage.get());
