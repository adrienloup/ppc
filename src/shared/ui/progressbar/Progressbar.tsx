...
export const Progressbar = ({ className, size = 'm', valueNow, valueMin = 0, valueMax = 100, completed = false }: ProgressbarType) => {
  return (
    <div
      className={classNames(styles.progressbar, styles[size], completed ? styles.completed : '', className)}
      role="progressbar"
