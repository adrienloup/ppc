...
import type { Translations } from '@/src/shared/type/Translation.ts';

const languages = ([key, value]: [string, ResourceKey]): [string, ResourceLanguage] => [key, { translation: value }];
