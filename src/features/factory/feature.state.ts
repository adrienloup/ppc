...
export const FEATURE_STATE: FeatureState = {
  clipper: { available: false, requirement: [{ asset: 'funds', value: 5 }] },
  ...
  megaClipper: { available: false, requirement: [{ asset: 'clipper', value: 75 }] },
  marketing: { available: false, requirement: [{ asset: 'funds', value: 200 }] },
